(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    })(exports.TransportEvents || (exports.TransportEvents = {}));
    ...
    var LocalTransport = /** @class */ (function () {
        ...
        LocalTransport.prototype.handshake = function () {
            if (this.connected) {
                this.trigger(exports.TransportEvents.connect);
            }
            else {
                this.connect();
            }
        ...
        LocalTransport.prototype.onStorageMessage = function (_a) {
            ...
            if (key && newValue && key.startsWith(this.preifx)) {
                ...
                if (this.isExternalMessage(message)) {
                    this.trigger(exports.TransportEvents.action, message);
                }
            }
        };
    ...
    var RxjsTransport = /** @class */ (function () {
        ...
        RxjsTransport.prototype.connect = function () {
            ...
            this.trigger(exports.TransportEvents.connect, null);
        };
    ...
    var Client = /** @class */ (function () {
        function Client(transport, dom) {
            ...
            transport.on(exports.TransportEvents.connect, function (event) {
                _this.dom.init();
            });
            transport.on(exports.TransportEvents.action, function (event) {
